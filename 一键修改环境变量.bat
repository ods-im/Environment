...
:: 提示用户选择 JDK 版本
:choose_jdk
echo 请选择要设置的 JAVA_HOME:
echo 1. jdk17
echo 2. jdk21
set /p choice="请输入 1 或 2: "
if "%choice%"=="1" (set "JAVA_HOME=%CURRENT_DIR%\jdk17") else if "%choice%"=="2" (set "JAVA_HOME=%CURRENT_DIR%\jdk21") else (
...
:: 设置 MAVEN_HOME
set "MAVEN_HOME=%CURRENT_DIR%\maven"
